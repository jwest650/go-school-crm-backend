...
<div class="sidebar" id="sidebar">
	...
	<div class="modern-profile p-3 pb-0">
		<div class="text-center rounded bg-light p-3 mb-4 user-profile">
			...
			<h6 class="fs-12 fw-normal mb-1"><?php echo $_SESSION['name'];  ?></h6>
	...
	<div class="sidebar-header p-3 pb-0 pt-2">
		<div class="text-center rounded bg-light p-2 mb-4 sidebar-profile d-flex align-items-center">
			...
			<div class="text-start sidebar-profile-info ms-2">
				<h6 class="fs-12 fw-normal mb-1 text-capitalize"><?php echo $_SESSION['name'];  ?></h6>
				<p class="fs-10">System Admin</p>
			</div>
		</div>
					...
					<ul>
						...
						<li class="submenu">
							...
							<ul>
								...
								<li><a href="companies.php" class="<?php echo ($page == 'companies.php') ? 'active' : ''; ?>">Schools</a></li>
					...
					<ul>
						<li class="<?php echo ($page == 'clients-grid.php') ? 'active' : ''; ?>">
							<a href="clients-grid.php">
								<i class="ti ti-users-group"></i><span>Admins</span>
							</a>
						</li>
