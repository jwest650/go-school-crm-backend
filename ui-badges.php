							...
							<div class="row">
								<div class="col-xl-12">
									<div class="card">
										...
										<div class="card-body">
											<span class="badge bg-secondary"><span class="badge-label">Secondary</span><i class="fa-solid fa-plus ms-1"></i></span>
											<span class="badge bg-success"><span class="badge-label">Success</span><i class="fa-solid fa-check ms-1"></i></span>
											<span class="badge bg-info"><span class="badge-label">Info</span><i class="fa-solid fa-circle-info ms-1"></i></span>
											<span class="badge bg-warning"><span class="badge-label">Warning</span><i class="fa-solid fa-circle-info ms-1"></i></span>
											<span class="badge bg-danger"><span class="badge-label">Danger</span><i class="fa-solid fa-x ms-1"></i></span>
										</div>
									</div>
									<div class="card">
										<div class="card-header">
										...
										<div class="card-body">
											<span class="badge bg-outline-secondary"><span class="badge-label">Secondary</span><i class="fa-solid fa-plus ms-1"></i></span>
											<span class="badge bg-outline-success"><span class="badge-label">Success</span><i class="fa-solid fa-check ms-1"></i></span>
											<span class="badge bg-outline-info"><span class="badge-label">Info</span><i class="fa-solid fa-circle-info ms-1"></i></span>
											<span class="badge bg-outline-warning"><span class="badge-label">Warning</span><i class="fa-solid fa-circle-info ms-1"></i></span>
											<span class="badge bg-outline-danger"><span class="badge-label">Danger</span><i class="fa-solid fa-x ms-1"></i></span>
										</div>
									</div>
								</div>
							</div>
