			...
			<div class="content">
				...
				<div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
					<div class="my-auto mb-2">
						...
						<nav>
							<ol class="breadcrumb mb-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Admin Grid</li>
							</ol>
						</nav>
					</div>
					<div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
						...
						<div class="mb-2">
							<a href="#" data-bs-toggle="modal" data-bs-target="#add_client" class="btn btn-primary d-flex align-items-center"><i class="ti ti-circle-plus me-2"></i>Add Admin</a>
						</div>
							...
							<div class="card-body">
								<div class="d-flex align-items-center justify-content-between">
									<div class="d-flex align-items-center">
										...
										<div>
											<p class="fs-12 fw-medium mb-0 text-gray-5 mb-1">Total Admin</p>
											<h4>300</h4>
										</div>
									</div>
							...
							<div class="card-body">
								<div class="d-flex align-items-center justify-content-between">
									<div class="d-flex align-items-center">
										...
										<div>
											<p class="fs-12 fw-medium mb-0 text-gray-5 mb-1">Active Admin</p>
											<h4>270</h4>
										</div>
									</div>
							...
							<div class="card-body">
								<div class="d-flex align-items-center justify-content-between">
									<div class="d-flex align-items-center">
										...
										<div>
											<p class="fs-12 fw-medium mb-0 text-gray-5 mb-1">Inactive Admin</p>
											<h4>30</h4>
										</div>
									</div>
							...
							<div class="card-body">
								<div class="d-flex align-items-center justify-content-between">
									<div class="d-flex align-items-center">
										...
										<div>
											<p class="fs-12 fw-medium mb-0 text-gray-5 mb-1">New Admins</p>
											<h4>300</h4>
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="mb-3 ">
												...
												<div class="pass-group">
													<input name="password" type="password" class="pass-inputs form-control">
