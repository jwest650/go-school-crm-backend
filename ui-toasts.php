						...
						<div class="row">
							...
							<div class="col-xl-6">
								<div class="card">
									...
									<div class="card-body">
										<div class="btn-list">
											<button type="button" class="btn btn-outline-primary me-1 btn-wave" id="primaryToastBtn">Primary</button>
											<button type="button" class="btn btn-outline-secondary me-1 btn-wave" id="secondaryToastBtn">Secondary</button>
											<button type="button" class="btn btn-outline-warning me-1 btn-wave" id="warningToastBtn">Warning</button>
											<button type="button" class="btn btn-outline-info me-1 btn-wave" id="infoToastBtn">Info</button>
											<button type="button" class="btn btn-outline-success me-1 btn-wave" id="successToastBtn">Success</button>
											<button type="button" class="btn btn-outline-danger me-1 btn-wave" id="dangerToastBtn">Danger</button>
										</div>
										<div class="toast-container position-fixed top-0 end-0 p-3">
							...
							<div class="col-xl-6">
								<div class="card">
									...
									<div class="card-body">
										<div class="btn-list">
											<button type="button" class="btn btn-primary me-1 btn-wave" id="solidprimaryToastBtn">Primary</button>
											<button type="button" class="btn btn-secondary me-1 btn-wave" id="solidsecondaryToastBtn">Secondary</button>
						...
						<div class="row">
							<div class="col-xl-12">
								<div class="card">
									...
									<div class="card-body">
										<div class="btn-list">
											<button type="button" class="btn btn-outline-primary me-1 btn-wave" id="topleftToastBtn">Top Left</button>
											<button type="button" class="btn btn-outline-primary me-1 btn-wave" id="topcenterToastBtn">Top Center</button>
											<button type="button" class="btn btn-outline-primary me-1 btn-wave" id="toprightToastBtn">Top Right</button>
											<button type="button" class="btn btn-outline-primary me-1 btn-wave" id="middleleftToastBtn">Middle Left</button>
											<button type="button" class="btn btn-outline-primary me-1 btn-wave" id="middlecenterToastBtn">Middle Center</button>
											<button type="button" class="btn btn-outline-primary me-1 btn-wave" id="middlerightToastBtn">Middle Right</button>
											<button type="button" class="btn btn-outline-primary me-1 btn-wave" id="bottomleftToastBtn">Bottom Left</button>
											<button type="button" class="btn btn-outline-primary me-1 btn-wave" id="bottomcenterToastBtn">Bottom Center</button>
											<button type="button" class="btn btn-outline-primary me-1 btn-wave" id="bottomrightToastBtn">Bottom Right</button>
										</div>
